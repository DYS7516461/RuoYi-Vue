<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="titleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="选题名称" align="center" prop="titleName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="教师ID" prop="teacherId">
          <el-input v-model="form.teacherId" placeholder="请输入选题名称" />
        </el-form-item>
        <el-form-item label="教师名称" prop="teacher.nickName">
          <el-input v-model="form.teacher.nickName" placeholder="请输入教师名称" />
        </el-form-item>
