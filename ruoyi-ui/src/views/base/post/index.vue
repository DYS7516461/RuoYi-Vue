...
<script>
import { listPost, getPost, delPost, addPost, updatePost } from "@/api/base/post";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除职位编号为"' + postIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('base/post/export', {
        ...this.queryParams
